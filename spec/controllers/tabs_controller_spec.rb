  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tab as @tab" do
        ...
        post :create, {:tab => { "name" => "invalid value" }}, valid_session
        assigns(:tab).should be_a_new(Tab)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tab" do
        ...
        Tab.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => tab.to_param, :tab => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tab as @tab" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tab.any_instance.stub(:save).and_return(false)
        put :update, {:id => tab.to_param, :tab => { "name" => "invalid value" }}, valid_session
        assigns(:tab).should eq(tab)
      end
